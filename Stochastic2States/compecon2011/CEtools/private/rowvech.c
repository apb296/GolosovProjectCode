...
double *outprod(double *A, double *B, int m, int n)
{
  double temp;
  long ij, ik, jk, ikstart, jkstart, mm, mn;
  mn=m*n;
  mm=m*m;
...
double *transpose(double *A, double *B, int m, int n)
{
  long ij, ji, jistart, mn;
  mn=m*n;
